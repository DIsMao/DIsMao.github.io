...
//Добавление блоков----------------------------------------------------------------------------------------------------------------------------------------------------
 function db_box1() {
 document.body.insertAdjacentHTML ('afterBegin', '<div class="main_box2" >'+ $( window ).width() +'</div>')
 $(".main_box2").draggable();
 $(".main_box2" ).resizable();
...
function div() {
	...
	var height1 = $('#div').css('height');
	var bgHeader = $('#div').css('backgroundColor');
	var border1 = $('#div').css('border');
	var position1 = $('#div').css('position');
	var top1 = $('#div').css('top');
	var left1 = $('#div').css('left');

	document.getElementById('div2').innerHTML = width1 + ", " + height1 + ", " + bgHeader + ", " + border1 + ", " + position1 + ", " + top1 + ", " + left1;
}
div()
...
function ajax() {
	$.get(
		"script.php",
		{
			"2q": {
				"2": {
					"width1": $('#div').css('width'),
					"height1": $('#div').css('height'),
					"bgHeader": $('#div').css('backgroundColor'),
					"border1": $('#div').css('border'),
					"position1": $('#div').css('position'),
					"top1": $('#div').css('top'),
					"left1": $('#div').css('left')
				}
			}
